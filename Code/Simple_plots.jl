...
function figure_1(settings)
    ...
    save_ts_unc_gmt(years,GMSL_20c./10,settings["dir_fig_1_gmsl_usa"]*"GMSL_20c.txt")
    save_ts_gmt(years,GMSL_Altimetry./10,settings["dir_fig_1_gmsl_usa"]*"GMSL_Altimetry.txt")
    save_ts_unc_gmt(years,GMSL_Trajectory./10,settings["dir_fig_1_gmsl_usa"]*"GMSL_Trajectory.txt")
    ...
    for scenario ∈ settings["NCA5_scenarios"]
        ...
        save_ts_unc_gmt(years,GMSL_scn./10,settings["dir_fig_1_gmsl_usa"]*"GMSL_"*scenario*".txt")
    end
    ...
    save_ts_gmt(years,USA_20c./10,settings["dir_fig_1_gmsl_usa"]*"USA_20c.txt")
    save_ts_gmt(years,USA_rsl_alt./10,settings["dir_fig_1_gmsl_usa"]*"USA_Altimetry.txt")
    save_ts_unc_gmt(years,USA_trajectory./10,settings["dir_fig_1_gmsl_usa"]*"USA_Trajectory.txt")
    ...
    for scenario ∈ settings["NCA5_scenarios"]
        ...
        save_ts_unc_gmt(years,USA_scn./10,settings["dir_fig_1_gmsl_usa"]*"USA_"*scenario*".txt")
...
function figure_2(settings)
    ...
    for (region_idx,region) ∈ enumerate(settings["regions"][2:end])
        ...
        save_ts_gmt(years,reg_20c./10,settings["dir_fig_2_regional"]*region*"_20c.txt")
        save_ts_gmt(years,reg_rsl_alt./10,settings["dir_fig_2_regional"]*region*"_Altimetry.txt")
        save_ts_unc_gmt(years,reg_trajectory./10,settings["dir_fig_2_regional"]*region*"_Trajectory.txt")
        ...
        for scenario ∈ settings["NCA5_scenarios"]
            ...
            save_ts_unc_gmt(years,reg_scn./10,settings["dir_fig_2_regional"]*region*"_"*scenario*".txt")
    ...
    plot(plot_array..., layout = (4,2),size=(1000,1200))
